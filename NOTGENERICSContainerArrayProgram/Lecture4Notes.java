 ...
 * @author liz10
 */
public class Lecture4Notes {

    /**
     * Github
     *      Repository
     *         Shares your code with the cloud
     *          essential for collaboration
     *          Version Control
     * 
     * Gitworkflow
     *      Idea is to have a main branch you can give to customers
     *      There should be a branch of code that is just for development and testing
     *          When you finish dev for a version, you could "merge" them into the master (main)
     *     
     * Push
     * Commit
     * Pull
